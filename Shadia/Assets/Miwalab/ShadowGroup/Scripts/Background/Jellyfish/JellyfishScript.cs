...
public class JellyfishScript : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        this.sm.box = new Vector3(13, 10, 10);

        this.mm.startRotation3D = true;
        this.mm.startRotationX = Mathf.PI / 2;
        this.mm.startRotationY = Random.Range(-Mathf.PI / 6, Mathf.PI / 6);
        this.mm.startRotationZ = 0;
    }
}
