...
namespace Miwalab.ShadowGroup.ImageProcesser
{
    class MoveShadow : AShadowImageProcesser
    {
        ...
        public MoveShadow() : base()
        {
            ...
            (ShadowMediaUIHost.GetUI("MoveShadow_Rate") as ParameterSlider).ValueChanged += MoveShadow_Rate_ValueChanged;
            ...
            (ShadowMediaUIHost.GetUI("MoveShadow_UseAtt") as ParameterCheckbox).ValueChanged += MoveShadow_UseAtt_ValueChanged;
            ...
            (ShadowMediaUIHost.GetUI("MoveShadow_Rate") as ParameterSlider).ValueUpdate();
            ...
            (ShadowMediaUIHost.GetUI("MoveShadow_UseAtt") as ParameterCheckbox).ValueUpdate();
        }
        ...
        private void MoveShadow_UseAtt_ValueChanged(object sender, EventArgs e)
        {
            this.useAtt = (bool)(e as ParameterCheckbox.ChangedValue).Value;
        }

        private void MoveShadow_Rate_ValueChanged(object sender, EventArgs e)
        {
        ...
        private void Update(ref Mat src, ref Mat dst)
        {
                ...
                if (BodyData[i].IsTracked)
                {
                    if (CheckBodyInSCreen(i, src))
                    {
                        ...
                        if (this.preBasePosDic.ContainsKey(i))
                        {
                            ...
                            if (baseMoveX > 3) baseMoveX = 3;
                            //this.baseAttractRad.Add(i, baseMoveX / 2 * Math.PI / 3);
                            this.baseAttractRad[i].Insert(0, baseMoveX / 3 * Math.PI / 6); 
            ...
            for (int i = 0; i < bodyContList.Count; i++)
            {
                ...
                {
                    //SpinBase
                    if (List_BoneRads[i].ContainsKey(Kinect.JointType.SpineBase) == true && List_BoneRads[targetContNum].ContainsKey(Kinect.JointType.SpineBase) == true)
                    {
                        SwapBodyMats.Add(Kinect.JointType.SpineBase, GetRotateMat(this.bodyContList[i][0].bodyNum, Kinect.JointType.SpineBase, List_BoneRads[targetContNum][Kinect.JointType.SpineBase] - List_BoneRads[i][Kinect.JointType.SpineBase]));
                    }
                    else
                    {
                    ...
                    //LeftShoulder
                    if (List_BoneRads[i].ContainsKey(Kinect.JointType.ShoulderLeft) == true && List_BoneRads[targetContNum].ContainsKey(Kinect.JointType.ShoulderLeft) == true)
                    {
                        SwapBodyMats.Add(Kinect.JointType.ShoulderLeft, GetRotateMat(this.bodyContList[i][0].bodyNum, Kinect.JointType.ShoulderLeft, List_BoneRads[targetContNum][Kinect.JointType.ShoulderLeft] - List_BoneRads[i][Kinect.JointType.ShoulderLeft], SwapBodyMats[Kinect.JointType.SpineBase]));
                    }
                    else
                    {
                        SwapBodyMats.Add(Kinect.JointType.ShoulderLeft, SwapBodyMats[Kinect.JointType.SpineBase]);
                    }
                    //LeftElbow
                    ...
                    {
                        SwapBodyMats.Add(Kinect.JointType.ElbowLeft, GetRotateMat(this.bodyContList[i][0].bodyNum, Kinect.JointType.ElbowLeft, List_BoneRads[targetContNum][Kinect.JointType.ElbowLeft] - List_BoneRads[i][Kinect.JointType.ElbowLeft], SwapBodyMats[Kinect.JointType.ShoulderLeft]));
                    }
                    else
                    {
                        SwapBodyMats.Add(Kinect.JointType.ElbowLeft, SwapBodyMats[Kinect.JointType.ShoulderLeft]);
                    }
                    //RightShoulder
                    if (List_BoneRads[i].ContainsKey(Kinect.JointType.ShoulderRight) == true && List_BoneRads[targetContNum].ContainsKey(Kinect.JointType.ShoulderRight) == true)
                    {
                        SwapBodyMats.Add(Kinect.JointType.ShoulderRight, GetRotateMat(this.bodyContList[i][0].bodyNum, Kinect.JointType.ShoulderRight, List_BoneRads[targetContNum][Kinect.JointType.ShoulderRight] - List_BoneRads[i][Kinect.JointType.ShoulderRight], SwapBodyMats[Kinect.JointType.SpineBase]));
                    }
                    else
                    {
                        SwapBodyMats.Add(Kinect.JointType.ShoulderRight, SwapBodyMats[Kinect.JointType.SpineBase]);
                    }
                    //RightElbow
                    if (List_BoneRads[i].ContainsKey(Kinect.JointType.ElbowRight) == true && List_BoneRads[targetContNum].ContainsKey(Kinect.JointType.ElbowRight) == true)
                    {
                        SwapBodyMats.Add(Kinect.JointType.ElbowRight, GetRotateMat(this.bodyContList[i][0].bodyNum, Kinect.JointType.ElbowRight, List_BoneRads[targetContNum][Kinect.JointType.ElbowRight] - List_BoneRads[i][Kinect.JointType.ElbowRight], SwapBodyMats[Kinect.JointType.ShoulderRight]));
                    }
                    else
                    {
                        SwapBodyMats.Add(Kinect.JointType.ElbowRight, SwapBodyMats[Kinect.JointType.ShoulderRight]);
                    }
                    //LeftHip
                ...
                if (useRot)
                {
                    ...
                    //SpinBase
                    if (List_BoneRads[i].ContainsKey(Kinect.JointType.SpineBase) == true)
                    {
                        SwapBodyMats.Add(Kinect.JointType.SpineBase, GetRotateMat(this.bodyContList[i][0].bodyNum, Kinect.JointType.SpineBase, List_BoneRads[i][Kinect.JointType.SpineBase] * 2));
                    ...
                    //LeftShoulder
                    if (List_BoneRads[i].ContainsKey(Kinect.JointType.ShoulderLeft) == true && List_BoneRads[i].ContainsKey(Kinect.JointType.SpineBase) == true)
                    {
                        SwapBodyMats.Add(Kinect.JointType.ShoulderLeft, GetRotateMat(this.bodyContList[i][0].bodyNum, Kinect.JointType.ShoulderLeft, List_BoneRads[i][Kinect.JointType.SpineBase] , SwapBodyMats[Kinect.JointType.SpineBase]));
                    }
                    else
                    {
                        SwapBodyMats.Add(Kinect.JointType.ShoulderLeft, SwapBodyMats[Kinect.JointType.SpineBase]);
                    ...
                    SwapBodyMats.Add(Kinect.JointType.ElbowLeft, SwapBodyMats[Kinect.JointType.ShoulderLeft]);
                    //RightShoulder
                    if (List_BoneRads[i].ContainsKey(Kinect.JointType.ShoulderRight) == true && List_BoneRads[i].ContainsKey(Kinect.JointType.SpineBase) == true)
                    {
                        SwapBodyMats.Add(Kinect.JointType.ShoulderRight, GetRotateMat(this.bodyContList[i][0].bodyNum, Kinect.JointType.ShoulderRight, List_BoneRads[i][Kinect.JointType.SpineBase] , SwapBodyMats[Kinect.JointType.SpineBase]));
                    }
                    else
                    {
                        SwapBodyMats.Add(Kinect.JointType.ShoulderRight, SwapBodyMats[Kinect.JointType.SpineBase]);
                    ...
                    SwapBodyMats.Add(Kinect.JointType.ElbowRight, SwapBodyMats[Kinect.JointType.ShoulderRight]);
                    //LeftHip
                    if (List_BoneRads[i].ContainsKey(Kinect.JointType.HipLeft) == true && List_BoneRads[i].ContainsKey(Kinect.JointType.SpineBase) == true)
                    {
                        if (List_BoneRads[i][Kinect.JointType.SpineBase] > 0) //状況を見て符号は変える
                        {
                            SwapBodyMats.Add(Kinect.JointType.HipLeft, GetRotateMat(this.bodyContList[i][0].bodyNum, Kinect.JointType.HipLeft, List_BoneRads[i][Kinect.JointType.SpineBase] ));
                        }
                        else
                        {
                            SwapBodyMats.Add(Kinect.JointType.HipLeft, Mat.Eye(3, 3, MatType.CV_32FC1));
                    ...
                    //RightHip
                    if (List_BoneRads[i].ContainsKey(Kinect.JointType.HipRight) == true && List_BoneRads[i].ContainsKey(Kinect.JointType.SpineBase) == true)
                    {
                        if (List_BoneRads[i][Kinect.JointType.SpineBase] <= 0) //状況を見て符号は変える
                        {
                            SwapBodyMats.Add(Kinect.JointType.HipRight, GetRotateMat(this.bodyContList[i][0].bodyNum, Kinect.JointType.HipRight, List_BoneRads[i][Kinect.JointType.SpineBase] ));
                        }
                        else
                        {
                            SwapBodyMats.Add(Kinect.JointType.HipRight, Mat.Eye(3, 3, MatType.CV_32FC1));
            ...
            this.List_BoneRads = this.List_PreBoneRads;
