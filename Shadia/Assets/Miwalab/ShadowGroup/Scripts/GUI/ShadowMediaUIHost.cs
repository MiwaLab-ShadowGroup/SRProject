...
public class ShadowMediaUIHost : MonoBehaviour
{
    ...
    {
        m_lastUpdatedHeight = 0;
        AddFloatUI(parent, "Jellyfish_Size", 5, 0.1f, 1);
        AddFloatUI(parent, "Jellyfish_Speed", 10, 0.1f, 5);
        AddFloatUI(parent, "Jellyfish_TotalNum", 1000, 100, 500);
        AddFloatUI(parent, "Jellyfish_EmitNum", 10, 1, 3);
        AddFloatUI(parent, "Jellyfish_Lifetime", 30, 0.1f, 1);
        m_lastUpdatedHeight += 10;
        AddFloatUI(parent, "Noise_Strength", 10, 0.1f, 3);
        AddFloatUI(parent, "Noise_Frequency", 0.1f, 0, 0.01f);
        m_lastUpdatedHeight += 10;
